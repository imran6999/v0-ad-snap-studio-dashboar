...
import { LayoutDashboard, Sparkles, FolderOpen, CreditCard, User, Menu, Bell, Search } from "lucide-react"
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center border-b border-border px-6">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold text-foreground">AdSnap Studio</span>
            </Link>
          </div>
